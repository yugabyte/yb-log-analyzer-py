...
solutions = {
    ...
    KB for more details: https://support.yugabyte.com/hc/en-us/articles/4403688844045-Throttling-mechanism-in-YugaByte-TServer-due-to-high-Memory-Usage-""",
    ...
    "SST files limit exceeded": """This means that we have too many SST files. This could be because of slow compaction or load on the system.
    KB for more details:https://support.yugabyte.com/hc/en-us/articles/4491328438413-Writes-failed-with-error-SST-files-limit-exceeded-"""
